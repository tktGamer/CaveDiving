 ...
 * @return なし
 */
void ShaderManager::StartShader(ShaderType type, ID3D11Buffer* cBuffer)
{
	switch (type)
	{
...
void ShaderManager::SetModelShader(ID3D11Buffer* cBuffer)
{
	ID3D11DeviceContext* context = m_graphics->GetDeviceResources()->GetD3DDeviceContext();
...
void ShaderManager::SetUIShader(ID3D11Buffer* cBuffer)
{
...
void ShaderManager::SetParticleShader(ID3D11Buffer* cBuffer)
{
	ID3D11DeviceContext* context = m_graphics->GetDeviceResources()->GetD3DDeviceContext();
	//	シェーダーにバッファを渡す
	ID3D11Buffer* cb[1] = { cBuffer };
...
void ShaderManager::SetFadeShader(ID3D11Buffer* cBuffer)
{
	ID3D11DeviceContext* context = m_graphics->GetDeviceResources()->GetD3DDeviceContext();
	//	シェーダーにバッファを渡す
	ID3D11Buffer* cb[1] = { cBuffer };
...
void ShaderManager::SetOutlineShader(ID3D11Buffer* cBuffer)
{
	ID3D11DeviceContext* context = m_graphics->GetDeviceResources()->GetD3DDeviceContext();
	//	シェーダーにバッファを渡す
	ID3D11Buffer* cb[1] = { cBuffer };
...
void ShaderManager::SetNumber2DShader(ID3D11Buffer* cBuffer)
{
...
void ShaderManager::SetNumber3DShader(ID3D11Buffer* cBuffer)
{
	ID3D11DeviceContext* context = m_graphics->GetDeviceResources()->GetD3DDeviceContext();
	//	シェーダーにバッファを渡す
	ID3D11Buffer* cb[1] = { cBuffer };

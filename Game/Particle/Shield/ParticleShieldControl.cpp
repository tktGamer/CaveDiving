/**
 * @file   ParticleShieldControl.cpp
 *
 * @brief  盾パーティクル管理に関するソースファイル
 *
 * @author 制作者名 福地貴翔
 *
 * @date   日付  2026/01/28
 ...
 * @return なし
 */
void ParticleShieldControl::Update()
{
 ...
 * @return なし
 */
void ParticleShieldControl::Render(const DirectX::SimpleMath::Vector3& target, const DirectX::SimpleMath::Vector3& cameraPos, const DirectX::SimpleMath::Vector3& cameraUp)
{
 ...
 * @return なし
 */
void ParticleShieldControl::Reset()
{
	ClearParticles();
	ClearVertex();
	ClearTimerAndPos();

 ...
 */
StatusUpItem::StatusUpItem(EffectType upStatus, int increase,GameObject* parent, const DirectX::SimpleMath::Vector3& initialPosition, const DirectX::SimpleMath::Quaternion& initialAngle)
	:Item{upStatus,increase,parent,initialPosition,initialAngle}
{
}
 ...
 * @return なし
 */
void StatusUpItem::Update(const DirectX::SimpleMath::Vector3& currentPosition, const DirectX::SimpleMath::Quaternion& currentAngle)
{
...
void StatusUpItem::Draw()
{
	...
	StatusUpItem::ConstBuffer cbuff;
 ...
 * @return なし
 */
void StatusUpItem::OnMessegeAccepted(Message::MessageID messageID)
{
	switch (messageID)
	{
	default:
 ...
 * @return なし
 */
void StatusUpItem::CollisionResponce(GameObject* other)
{
